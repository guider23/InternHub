                  ...
                  <div className="flex-1 p-4 sm:p-6">
                    <div className="prose max-w-none mb-6">
                      <div
                        className="text-gray-800 leading-relaxed"
                        dangerouslySetInnerHTML={{
                          __html: (ans.answerBody || ans.answerbody || "")
                            .replace(
                              /## (.*)/g,
                              '<h3 class="text-lg font-semibold mt-6 mb-3 text-gray-900">$1</h3>'
                            )
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                      ...
                      <div className="flex items-center gap-2 text-sm">
                        <span className="text-gray-600">
                          answered {ans.answeredOn || ans.answeredon}
                        </span>
                        <Link
                          href={`/users/${ans.userId || ans.userid}`}
                          className="flex items-center gap-2 hover:bg-blue-50 p-2 rounded"
                        >
                          <Avatar className="w-8 h-8">
                            <AvatarFallback className="text-sm">
                              {(ans.userAnswered || ans.useranswered)?.[0] || "U"}
                            </AvatarFallback>
                          </Avatar>
                          <div>
                            <div className="text-blue-600 hover:text-blue-800 font-medium">
                              {ans.userAnswered || ans.useranswered || "Anonymous"}
                            </div>
                          </div>
                        </Link>
                      </div>
