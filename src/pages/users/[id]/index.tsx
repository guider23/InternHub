          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600 mb-4">
              <div className="flex items-center">
                ...
                Member since{" "}
                {users.createdAt ? new Date(users.createdAt).toISOString().split("T")[0] : "N/A"}
              </div>
              <div className="flex items-center">
                <span className="font-semibold">{users.points || 0}</span>
                <span className="text-gray-600 ml-1">points</span>
              </div>
              <div className="flex items-center">
                <span className="font-semibold">{users.friendCount || 0}</span>
